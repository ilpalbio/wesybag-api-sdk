...
``` bash  
npm i @ilpalbio/wesybag-api-sdk@github:undefined
```
...
``` typescript
import { setup, setAuth } from "@ilpalbio/wesybag-api-sdk"
...
interact with the @ilpalbio/wesybag-api-sdk. Below, you'll find the signatures of all
