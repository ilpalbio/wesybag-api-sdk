...
/**
Send a confirmation link to the phone number
*/
export type AxiosSendPhoneConfirmationTokenSuccessResponse = (AxiosResponse<SendPhoneConfirmationToken200ResponseSchema> & { status: 200 })
export type AxiosSendPhoneConfirmationTokenErrorResponse = ((AxiosResponse<SendPhoneConfirmationToken400ResponseSchema> & { status: 400 }) | (AxiosResponse<SendPhoneConfirmationToken404ResponseSchema> & { status: 404 }) | (AxiosResponse<SendPhoneConfirmationToken405ResponseSchema> & { status: 405 }) | (AxiosResponse<SendPhoneConfirmationToken415ResponseSchema> & { status: 415 }) | (AxiosResponse<SendPhoneConfirmationToken429ResponseSchema> & { status: 429 }) | (AxiosResponse<SendPhoneConfirmationToken500ResponseSchema> & { status: 500 })) & { path: "/v1/signup/sendPhoneConfirmationToken" }
export type AxiosSendPhoneConfirmationTokenResponse = AxiosSendPhoneConfirmationTokenSuccessResponse | AxiosSendPhoneConfirmationTokenErrorResponse
export async function sendPhoneConfirmationToken(data: SendPhoneConfirmationTokenRequestSchema, config?: AxiosRequestConfig): Promise<AxiosSendPhoneConfirmationTokenResponse> {
  _checkSetup()
  const securityParams: AxiosRequestConfig = {}
  const handledResponses = {
    "200": {
  ...
  try {
    const res = await axios!.post(_getFnUrl("/v1/signup/sendPhoneConfirmationToken"), data, config ? deepmerge(securityParams, config, { isMergeableObject: isPlainObject }) : securityParams)
    _throwOnUnexpectedResponse(handledResponses, res)
    return res as AxiosSendPhoneConfirmationTokenSuccessResponse
  } catch (e) {
    const { response: res } = e as AxiosError
    if (res) {
      _throwOnUnexpectedResponse(handledResponses, res)
      return res as AxiosSendPhoneConfirmationTokenErrorResponse
    } else {
      throw e
    }
  }
...
/**
Confirm the phone number with the token
*/
export type AxiosVerifyPhoneConfirmationTokenSuccessResponse = (AxiosResponse<VerifyPhoneConfirmationToken200ResponseSchema> & { status: 200 })
export type AxiosVerifyPhoneConfirmationTokenErrorResponse = ((AxiosResponse<VerifyPhoneConfirmationToken400ResponseSchema> & { status: 400 }) | (AxiosResponse<VerifyPhoneConfirmationToken404ResponseSchema> & { status: 404 }) | (AxiosResponse<VerifyPhoneConfirmationToken405ResponseSchema> & { status: 405 }) | (AxiosResponse<VerifyPhoneConfirmationToken410ResponseSchema> & { status: 410 }) | (AxiosResponse<VerifyPhoneConfirmationToken415ResponseSchema> & { status: 415 }) | (AxiosResponse<VerifyPhoneConfirmationToken429ResponseSchema> & { status: 429 }) | (AxiosResponse<VerifyPhoneConfirmationToken500ResponseSchema> & { status: 500 })) & { path: "/v1/signup/verifyPhoneConfirmationToken" }
export type AxiosVerifyPhoneConfirmationTokenResponse = AxiosVerifyPhoneConfirmationTokenSuccessResponse | AxiosVerifyPhoneConfirmationTokenErrorResponse
export async function verifyPhoneConfirmationToken(data: VerifyPhoneConfirmationTokenRequestSchema, config?: AxiosRequestConfig): Promise<AxiosVerifyPhoneConfirmationTokenResponse> {
  _checkSetup()
  const securityParams: AxiosRequestConfig = {}
  const handledResponses = {
    "200": {
  ...
  try {
    const res = await axios!.post(_getFnUrl("/v1/signup/verifyPhoneConfirmationToken"), data, config ? deepmerge(securityParams, config, { isMergeableObject: isPlainObject }) : securityParams)
    _throwOnUnexpectedResponse(handledResponses, res)
    return res as AxiosVerifyPhoneConfirmationTokenSuccessResponse
  } catch (e) {
    const { response: res } = e as AxiosError
    if (res) {
      _throwOnUnexpectedResponse(handledResponses, res)
      return res as AxiosVerifyPhoneConfirmationTokenErrorResponse
    } else {
      throw e
    }
  }
...
export type SendPhoneConfirmationToken200ResponseSchema = OkResponseSchema

export type SendPhoneConfirmationToken400ResponseSchema = ValidationErrorResponseSchema

export type SendPhoneConfirmationToken404ResponseSchema = SessionNotFoundErrorResponseSchema

export type SendPhoneConfirmationToken405ResponseSchema = MethodNotAllowedErrorResponseSchema

export type SendPhoneConfirmationToken415ResponseSchema = UnsupportedMediaTypeErrorResponseSchema

export type SendPhoneConfirmationToken429ResponseSchema = ThrottlingErrorResponseSchema

export type SendPhoneConfirmationToken500ResponseSchema = UnexpectedErrorResponseSchema

export type SendPhoneConfirmationTokenRequestSchema = SessionIdSchema

export type VerifyPhoneConfirmationToken200ResponseSchema = SignupUserRequestSchema

export type VerifyPhoneConfirmationToken400ResponseSchema = ValidationErrorResponseSchema

export type VerifyPhoneConfirmationToken404ResponseSchema = ConfirmUserPhoneTokenNotFoundErrorResponseSchema

export type VerifyPhoneConfirmationToken405ResponseSchema = MethodNotAllowedErrorResponseSchema

export type VerifyPhoneConfirmationToken410ResponseSchema = ConfirmUserPhoneTokenIsExpiredErrorResponseSchema

export type VerifyPhoneConfirmationToken415ResponseSchema = UnsupportedMediaTypeErrorResponseSchema

export type VerifyPhoneConfirmationToken429ResponseSchema = ThrottlingErrorResponseSchema

export type VerifyPhoneConfirmationToken500ResponseSchema = UnexpectedErrorResponseSchema

export type VerifyPhoneConfirmationTokenRequestSchema = {
  token: string
  [k: string]: unknown
}
